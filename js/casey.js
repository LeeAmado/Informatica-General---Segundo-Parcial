// -- DATOS CURIOSOS SOBRE CASEY REAS --
...
let datosCuriosos = [
  ...
  "Ha trabajado como profesor en la UCLA (Universidad de California, Los Ángeles).",
  "Explora el arte generativo como un proceso basado en reglas simples que producen resultados complejos.",
  "Además de obras digitales, ha realizado impresiones generativas de gran formato."
];
...
function mostrarDato() {
  ...
  // -- Mostramos el dato correspondiente --
